...
entrada = input("Pesquise a previsão do tempo da sua cidade (cidade e sigla do estado): ")
...
if len(cidade) >= 2:
    print("\nLoading...\n")
    content = requests.get("https://g1.globo.com/previsao-do-tempo/"+estado+"/"+cidade+".ghtml")
...
lista.append(raios)
print(" -----------------------------------------------------------------------")
print("| Prob. de chuva: ",lista[0][0], "-",lista[0][1], "\t\t|\tVento: ",lista[3][0],"\t\t|")
print("| Nascer do sol: ",lista[1][0], "\t\t|\tUmidade: ",lista[4][0],"\t\t|")
print("| Pôr do sol: ",lista[2][0], "\t\t\t|\tRaios UV: ",lista[5][0],"\t|")
print(" -----------------------------------------------------------------------")
